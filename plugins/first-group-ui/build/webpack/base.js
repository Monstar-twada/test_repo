  ...
  return {
        ...
        },
        {
          ...
          use: [
            ...
            'sass-loader',
            {
              ...
              options: {
                resources: [
                  resolve(__dirname, `../../src/assets/scss/theme-${theme}.scss`),
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        filename: 'index.html',
        vueScript: isDev ? '' : '<script src="https://cdn.jsdelivr.net/npm/vue"></script>',
        docStyle: isDev ? '' : '<link rel="stylesheet" id="docCss" href="./doc.blue.css">',
        inject: false
      })
    ]
  }
