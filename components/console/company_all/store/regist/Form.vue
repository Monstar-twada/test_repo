<template>
  <div class="company_all-store-regist-form-container">
    <div class="company_all-store-regist-form-container_body">
      <div class="page-title-wrapper">
        <h2>店舗追加 <span>[ 岡田自動車株式会社 ]</span></h2>
      </div>
      <fg-form label-width="150px">
        ...
        <fg-form-item label="郵便番号">
          ...
          <fg-text
            ...
            class="company_all-store-regist-form-container__error"
    ...
    <div class="company_all-store-regist-form-container_bottom">
      <fg-button
...
<style lang="scss">
.company_all-store-regist-form-container {
  max-width: 712px;
  width: 100%;
  margin: 0 auto;
  color: $--color-primary;
